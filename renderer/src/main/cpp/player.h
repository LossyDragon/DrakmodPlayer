...
void xmp_getPatternRow(JNIEnv* env, jint pat, jint row, jbyteArray notes, jbyteArray instruments, jbyteArray fxType, jbyteArray fxParm, jbyteArray fx2Type, jbyteArray fx2Parm);
...
void openmpt_getPatternRow(JNIEnv* env, jint pat, jint row, jbyteArray notes, jbyteArray instruments, jbyteArray fxType, jbyteArray fxParm, jbyteArray fx2Type, jbyteArray fx2Parm);
